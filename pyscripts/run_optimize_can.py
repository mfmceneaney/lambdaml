...
argparser = argparse.ArgumentParser(description="Run hyperparameter optimization on the contrastive loss pipeline")
...
argparser.add_argument(
    ...
    help="Path for projector",
)

argparser.add_argument(
    "--projector_params_path",
    type=str,
    default="projector_params.json",
    help="Path for projector params",
)

...
class TITOKModelWrapper:
    def __init__(self, encoder_type=FlexibleGNNEncoder, encoder_path='encoder.pt', encoder_params_path="encoder_params.json",
                        clf_type=GraphClassifier, clf_path='clf.pt', clf_params_path="clf_params.json",map_location='cpu'):
...
def select_best_model(
    ...
    study = optuna.load_study(
        study_name="gnn_study",
        storage="sqlite:///optuna.db"  # or use your DB URI
    )

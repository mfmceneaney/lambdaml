...
file_list = [
     '/volatile/clas12/users/mfmce/mc_jobs_rga_C12TRAINS_vtx_3_5_25/analysis2/kinematics_*.hipo'
]
banks = [
    'REC::Particle',
    # 'REC::Traj',
...
#         print("DEBUGGING: edge_index.t().contiguous() = ",edge_index.t().contiguous())
        ...
        data.isdata      = torch.tensor([0],dtype=torch.long) #NOTE: Add extra dimension here so that training gets target batch dimension right.
